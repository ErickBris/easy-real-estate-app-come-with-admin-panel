			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td><a class="btn btn-info"  href="<?php echo base_url().'admin/types/edit?id='.$r->id;?>"><?php echo lang('msg_edit');?></a></td>
						<td><a class="btn btn-danger" href="<?php echo base_url().'admin/types/delete?id='.$r->id;?>" onclick="return confirm('<?php echo lang('msg_confirm_delete');?>')"><?php echo lang('msg_delete');?></a></td>
					</tr>
					<?php }?>
				</tbody>
			</table>
